...
// For running the application inside teams
...
async function getAccessToken2() {
    // Get the access token from teams if the app is running inside teams
    if (await inTeams()) {
...
export async function logoff() {
    ...
    // No need to logout if the app is running inside teams
    if (!(await inTeams())) {
